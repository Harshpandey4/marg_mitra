...
import 'anonymous_sos_screen.dart';
...
class _IntegratedLoginScreenState extends ConsumerState<IntegratedLoginScreen>
  ...
  void _navigateToAnonymousSos() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const AnonymousSosScreen(),
      ),
    );
  }
      ...
      body: SafeArea(
        child: Stack(
          children: [
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(20),
                                child: Padding(
                                  padding: EdgeInsets.all((isTablet ? 100 : 80) * 0.15),
                                  child: _isOTPSent
                                      ? Icon(
                                    Icons.sms_rounded,
                                    size: isTablet ? 50 : 40,
                        ...
                        if (!_isOTPSent) ...[
                          ...
                          const SizedBox(height: 100), // Extra space for SOS button
                        ],
                      ],
                    ),
                  ),
            ...
            // Attractive Floating SOS Button - Bottom Center
            Positioned(
              bottom: 20,
              left: 0,
              right: 0,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const Text(
                                            'Instant help • Tap for emergency',
                                            style: TextStyle(
                                              fontSize: 10,
                                              color: Colors.white,
                                              fontWeight: FontWeight.w500,
